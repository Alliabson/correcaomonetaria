...
# ==============================================================================
# Cache em memória simples para a sessão atual (evita lentidão no recálculo)
...
def calcular_correcao_media(valor: float, data_original: date, data_referencia: date, indices: list) -> dict:
    ...
    for ind in indices:
        ...
        if res['sucesso']:
            ...
            # Se um falhar na média, a média falha? 
            # Geralmente sim, ou distorce o valor. Vamos avisar.

...
# Adiciona o diretório pai ao path para garantir que os imports funcionem
...
try:
    ...
    st.error("Erro ao importar módulos necessários. Verifique a estrutura de diretórios.")
    st.stop()
